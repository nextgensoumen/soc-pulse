...
const headingStyle = (color = '#FFd600') => ({
  color,
  marginTop: '1.5rem',
  marginBottom: '0.8rem',
...
const firstHeadingStyle = { color: '#FFd600', marginBottom: '0.8rem', borderBottom: '1px solid rgba(255, 214, 0, 0.2)', paddingBottom: '0.3rem' };
const dashboardHeadingStyle = { color: '#FF6D00', marginTop: '1.5rem', marginBottom: '0.8rem' };
const listStyle = { listStyleType: 'disc', paddingLeft: '1.5rem', lineHeight: '1.8' };
  ...
  1: {
    ...
    renderContent: () => (
      <div className="doc-content-container">
        <h3 style={firstHeadingStyle}>🔍 What is it?</h3>
        ...
        <h3 style={headingStyle()}>🛑 Why is it needed?</h3>
        ...
        <h3 style={headingStyle()}>🛡️ How does it help the SOC?</h3>
        ...
        <h3 style={dashboardHeadingStyle}>🖥️ Dashboard Features: What It Actually Shows</h3>
        <ul style={listStyle}>
  ...
  4: {
    ...
    renderContent: () => (
      <div className="doc-content-container">
        ...
        <h3 style={dashboardHeadingStyle}>🖥️ Dashboard Features: What It Actually Shows</h3>
        <ul style={listStyle}>
          <li><strong>🔴 Vulnerable (Action Required):</strong> If a CVE could not be auto-patched, it provides manual commands to secure the system.</li>
...
const DocumentationView = ({ moduleId, onBack }) => {
  ...
  if (!doc) return (
    <div className="glass-panel" style={{ padding: '30px', margin: '20px', color: 'white' }}>
      <p>No documentation found for module {moduleId}. Please go back and try again.</p>
      <button onClick={onBack} style={{ marginTop: '20px', background: 'rgba(255,214,0,0.1)', border: '1px solid rgba(255,214,0,0.3)', color: '#FFd600', padding: '8px 16px', borderRadius: '20px', cursor: 'pointer', fontFamily: 'inherit' }}>
        ← Back to Dashboard
      </button>
    </div>
  );
  ...
  return (
    <div className="glass-panel" style={{ padding: '30px', margin: '20px' }}>
      <button
        ...
        onMouseOver={(e) => e.currentTarget.style.background = 'rgba(255, 214, 0, 0.1)'}
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '20px' }}>
        ...
        <h2 style={{ fontSize: '2rem', margin: 0, letterSpacing: '1px', textShadow: '0 0 10px rgba(255, 255, 255, 0.2)' }}>
          {doc.title} — Deep Dive Documentation
        </h2>
      </div>
